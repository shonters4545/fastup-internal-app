  ...
  return (
    <div className="w-full max-w-6xl card p-8 animate-fade-in mt-8">
      <div className="flex justify-between items-center mb-6 border-b dark:border-gray-800 pb-4">
        <h1 className="text-3xl font-bold text-gray-800 dark:text-gray-100">記事管理</h1>
        <button
              ...
              {posts.map(post => (
                <tr key={post.id} className="hover:bg-gray-50 dark:hover:bg-gray-800/50 transition-colors">
                  <td className="px-6 py-4 whitespace-nowrap">
                    <Link href={`/timeline/${post.id}`} className="text-sm font-medium text-gray-800 dark:text-gray-100 hover:text-primary-600 dark:hover:text-primary-400">
                      {post.title}
                    </Link>
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                    <Link href={`/admin/edit-post/${post.id}`} className="text-primary-600 hover:text-primary-900 dark:text-gray-400 dark:hover:text-gray-200">編集</Link>
